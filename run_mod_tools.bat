...
@start /D "%steampath%\steamapps\common\Team Fortress Classic Source" hl2.exe -steam +sv_cheats 1 -game "%CD%" -sw -dev -console -allowdebug -condebug -high -conclearlog -noborder -nojoy -r_emulate_gl +r_lod 0 -nop4 -tools
